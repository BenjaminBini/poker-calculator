...
const CardSelector = ({ addCard, game }) => {
  ...
  return (
    <div className="bg-slate-800 py-4 px-6 dk:mb-6 dk:rounded-xl flex items-center justify-center dk:relative fixed bottom-0 left-0 right-0 z-50 bg-opacity-40 dk:bg-opacity-100 backdrop-blur-lg dk:backdrop-blur-none">
