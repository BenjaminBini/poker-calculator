...
const playerClassNames = [
  ...
  "dk:top-0 dk:left-1/4 dk:-translate-x-1/2 dk:-translate-y-[60px]",
  "dk:top-0 dk:left-1/2 dk:-translate-x-1/2 dk:-translate-y-[60px]",
  "dk:top-0 dk:left-3/4 dk:-translate-x-1/2 dk:-translate-y-[60px]",
...
const PlayerHand = ({
  ...
  <div
    key={i}
    className={`z-10 hover:z-20 text-slate-100  dk:absolute ${playerClassNames[i]} group flex gap-4`}
  >
    <div
      className={`dk:w-[124px] z-10 hover:z-20  shadow-xl rounded-md  bg-slate-600 bg-opacity-50 backdrop-blur-md`}
    >
    ...
    {handEvals.length > 0 && hand.every((c) => c !== "") && (
      <div
        className={`bg-slate-800 bg-opacity-80 rounded-md p-2 dk:my-2 w-[158px] dk:absolute dk:hidden dk:group-hover:block dk:group-hover:animate-apparate ${
